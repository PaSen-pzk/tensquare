...
public class ProblemService {
	...
	public Page<Problem> hotlist(String labelid,int page,int rows){
		Pageable pageable = PageRequest.of(page-1,rows);
		return this.problemDao.hotlist(labelid,pageable);
	}
	public Page<Problem> waitlist(String label,int page,int rows){
		Pageable pageable = PageRequest.of(page-1,rows);
		return this.problemDao.waitlist(label,"0",pageable);
	}
